    ...
    render () {
        return(
            ...
            <br />
                ...
                <Link to={"/"+localStorage.ptspotter_donorId+"/report"}>Click to View Report</Link>
                </VerticalTimelineElement>
                ...
                Recipient : {this.state.item.recipient==null?"":(this.state.item.recipient).replace('resource:org.organ.net.Recipient#','')}
                </VerticalTimelineElement>
